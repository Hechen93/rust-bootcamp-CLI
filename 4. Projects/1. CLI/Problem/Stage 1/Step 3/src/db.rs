...
impl JiraDatabase {
    pub fn new(file_path: String) -> Self {
        JiraDatabase {
            //Return a box pointer to Database
            database: Box::new(JSONFileDatabase { file_path }), //create a new db instance that implements a DB, which is assigned to database field
        }
    }
